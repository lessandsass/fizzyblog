...
<div class="flex">
    ...
    <div class="w-3/5 border border-gray-600 h-auto  border-t-0">
        ...
        <div>
            <form action="{{ route('fizzies.update', $fizzy->id) }}" method="post">
                ...
                <div class="pl-16 pr-6">
                    <p class="text-base width-auto font-medium text-white flex-shrink">
                        ...
                        <div class="flex-1 px-2 pt-2 mt-2">
                            @csrf
                            @method('put')
                            <textarea name="content" id="content" class=" bg-transparent text-gray-400 font-medium text-lg w-full ring-0 focus-none outline-none" rows="2" cols="5" placeholder="What's happening?">{{ $fizzy->content }}</textarea>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="flex-1 text-center py-2 m-2">
                                <form action="{{ route('fizzies.update', $fizzy->id) }}" method="post">
                                    @csrf
                                    @method('put')
                                <button class="w-12 mt-1 group flex items-center text-gray-500 px-3 py-2 text-base leading-6 font-medium rounded-full hover:bg-gray-800 hover:text-gray-300">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
