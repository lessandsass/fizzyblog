<form action="{{ route('fizzies.store') }}" method="post">
    ...
    <div class="flex">
        ...
        <div class="flex-1 px-2 pt-2 mt-2">
            @csrf
            <textarea name="content" class=" bg-transparent text-gray-400 font-medium text-lg w-full ring-0 focus-none outline-none" rows="2" cols="50" placeholder="What's happening?"></textarea>

            @error('content')
                <div class="text-red-500 text-sm mt-5">
                    {{ $message }}
                </div>
            @enderror
    ...
    <div class="flex">
        ...
        <div class="w-64 px-2">
            ...
            <div class="flex items-center">
                ...
                <div class="flex-1 text-center px-1 py-1 m-2">
                    <a href="#" class="mt-1 group flex items-center text-gray-400 px-2 py-2 text-base leading-6 font-medium rounded-full hover:bg-gray-800 hover:text-gray-300">
        ...
        <div class="flex-1">
            <button class="bg-gray-400 mt-5 hover:bg-gray-600 text-white font-bold py-2 px-8 rounded-full mr-8 float-right">
                Tweet
            </button>
        </div>
